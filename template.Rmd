...
Looking at this visual, we can see that there has been an overall increase in phrase repetition in country songs since the 1950s.The 2000's has the highest spike of the average count of most repeated phrases in songs, which was greater than 10.0. The 2010's then still have a slight dip, but the overall trends are increasing from 1950's till the 2020's. 
